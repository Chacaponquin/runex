...
export default function Buttons({ handleAddToCart, handleBuyNow }: Props) {
  return (
    <div className="grid grid-cols-2 gap-x-4 exsm:grid-cols-1 gap-y-2">
      <button
        className="rounded bg-black text-white text-lg px-4 py-2 w-full font-fontMedium"
      ...
      <button
        ...
        className="w-full bg-blue-500 text-lg text-white rounded px-4 py-2 flex gap-x-4 stroke-white justify-center items-center"
      >
        <Bag size={22} />
